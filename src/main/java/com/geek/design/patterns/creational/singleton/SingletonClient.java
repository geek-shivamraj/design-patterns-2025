package com.geek.design.patterns.creational.singleton;

import com.geek.design.patterns.creational.singleton.eagerIntantiation.EagerSingleton;
...
public class SingletonClient {
    public static void main(String[] args) {
        ...
        System.out.println("Eager Singleton 1 : " + singleton1.hashCode());

        EagerSingleton singleton2 = EagerSingleton.getInstance();
        System.out.println("Eager Singleton 2 : " + singleton2.hashCode());
    }
}
